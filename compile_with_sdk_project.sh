...
echo "replace step 2"
sed -i.bak "s/^    implementation 'com.github.GrimReaperFloof:matrix-android-sdk/    \/\/implementation 'com.github.GrimReaperFloof:matrix-android-sdk/" ./vector/build.gradle || true
